...
export { getSkillBadges, isSkillDeprecated, isSkillHighlighted, isSkillOfficial } from '../components/skillDetailUtils'

export function buildSkillHref(ownerHandle: string | null, ownerId: string | null, slug: string) {
