...
function SoulsIndex() {
  ...
  // Phase 1: Placeholder souls data
  const souls: PublicSoul[] = []
  const isLoadingSouls = false
          ...
          <p className="section-subtitle" style={{ marginBottom: 0 }}>
            {isLoadingSouls
              ...
              : copy.countLabel
                  ...
                  .replace('{totalPart}', typeof total === 'number' ? copy.totalPart.replace('{total}', String(total)) : '')}
          </p>
        </div>
        <div className="skills-toolbar">
          ...
          <div className="skills-toolbar-row">
            ...
            <button
              ...
              type="button"
              aria-label={copy.sortDirectionAria.replace('{direction}', dir === 'asc' ? copy.sort.asc : copy.sort.desc)}
              onClick={() => {
                void navigate({
                  search: (prev) => ({
                    ...prev,
        ...
        <div className="grid">
          {sorted.map((soul) => (
            <SoulCard
              key={soul._id}
              soul={soul}
              summaryFallback={copy.summaryFallbackCard}
              meta={
                <div className="stat">
          ...
          {sorted.map((soul) => (
            ...
            >
              <div className="skills-row-main">
                ...
                <div className="skills-row-summary">{soul.summary ?? copy.summaryFallbackList}</div>
              </div>
